...
<head>
    ...
    {{-- <link rel="stylesheet" type="text/css" href="{{ asset('assets') }}/app-asset/themes/dark-layout.css"> --}}
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class=" nav-item {{ request()->is('pendapatan')? 'active': '' }}">
                    <a href="{{ route('pendapatan.index') }}"><i class="feather icon-credit-card"></i><span class="menu-title" data-i18n="Email">Pendapatan</span></a>
                </li>
                <li class=" nav-item {{ request()->is('pengeluaran')? 'active': '' }}">
                    <a href="{{ route('pengeluaran.index') }}"><i class="feather icon-edit"></i><span class="menu-title" data-i18n="Email">Pengeluaran</span></a>
                </li>
                <li class=" nav-item {{ request()->is('tabungan')? 'active': '' }}">
                    <a href="{{ route('tabungan.index') }}"><i class="feather icon-edit-1"></i><span class="menu-title" data-i18n="Email">Tabungan</span></a>
                </li>
            </ul>
        </div>
    </div>

<div class="modal fade" id="Update{{ $item->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('pendapatan.update',[$item->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <div class="controls">
                                    <textarea class="form-control" name="description" id="basicTextarea" rows="3" placeholder="Deskripsion">{{ $item->description }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
